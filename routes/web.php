...
Route::get('/estimate/{id}/pdf', [EstimatePdf::class, 'download'])
    ->name('estimate.pdf');
Route::get('/estimate/{id}/view', [EstimatePdf::class, 'preview'])
    ->name('estimate.view');
// PR INVOICE     
...
Route::get('estimate-portal/{id}', QuotationPortal::class)->name('quotation-portal');
