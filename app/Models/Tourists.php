...
class Tourists extends Model
{
    ...
    protected $fillable = ['flag', 'name', 'date', 'source_id', 'primary_contact',    'contact_email', 'contact_phone', 'address', 'city_suburb', 'state',    'zip_code', 'country_id', 'birthday', 'anniversary', 'other_id', 'base_currency_code', 'reference'];
