                            ...
                            <div class="mb-3">
                                <div class="form-group">
                                    ...
                                    <select id="client_id" class="form-select select2" wire:model="client_id"
                                        placeholder="Client Name" data-show-add="+ New Client" data-add-callback="ClientAdd" disabled >
                                        <option value=""></option>
                            ...
                            <div class="mb-3">
                                <div class="form-group">
                                    <label for="title" class="form-label d-flex justify-content-between">Tour Name
                                        @if ($tour_id)
                                        <span wire:click="edit" style="cursor: pointer;color: #E41F07;"><i class="lni lni-pencil me-2"></i>Edit    <span wire:loading wire:target="edit">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <button type="button" class="btn bluegradientbtn" wire:click="addItem">
                                    Add Item
                        ...
                        <div class="col-md-4">
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td class="text-end">
                                        {{$currency}} {{ \App\Helpers\SettingHelper::formatCurrency($totalAmount ?? 0, \App\Helpers\SettingHelper::getGenrealSettings('number_format')) }}
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        @endforeach
                          ...
                          <div class="d-flex justify-content-between">
                            <a class="btn btn-dark my-3" wire:click='edit'>Back</a>
                                <a class="btn bluegradientbtn my-3 " wire:click='edit'>Save <span wire:loading wire:target="edit">
                                <span class="spinner-border spinner-border-sm me-1" role="status"
                                    aria-hidden="true"></span>
                            </span></a>
                        </div>
