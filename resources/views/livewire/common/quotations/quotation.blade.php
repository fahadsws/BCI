                    ...
                    <table class="table table-hover align-middle mb-0" style="min-width: 100%;min-height: 200px;">
                        <thead style="background: linear-gradient(135deg, #f9fafb 0%, #f3f4f6 100%);">
                            <tr>
                                ...
                                <th width="15%"
                                    style="width: 120px; padding: 12px 16px; font-weight: 600; color: #374151;">USD
                                </th>
                                <th width="15%"
                                    style="width: 120px; padding: 12px 16px; font-weight: 600; color: #374151;">INR
                                </th>
                                <th></th>
                            </tr>
                        </thead>
                            ...
                            @forelse ($items as $index => $item)
                                ...
                                <tr wire:key="{{ $item->id }}"
                                    ...
                                    <td class="p-3">
                                        @if ($item->usd_amount)
                                            <a href="{{ $estimateRoute }}" class="fw-500 text-dark">
                                                {{ \App\Helpers\SettingHelper::formatCurrency($item->usd_amount ?? 0, 'comma_dot') }}
                                            </a>
                                        @else
                                            <span>NA</span>
                                        @endif
                                    ...
                                    <td class="p-3">
                                        @if ($item->inr_amount)
                                            <a href="{{ $estimateRoute }}" class="fw-500 text-dark">
                                                {{ \App\Helpers\SettingHelper::formatCurrency($item->inr_amount ?? 0, 'comma_dot') }}
                                            </a>
                                        @else
                                            <span>NA</span>
                                        @endif
