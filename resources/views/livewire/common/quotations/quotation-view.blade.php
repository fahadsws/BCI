    ...
    <div>
        <div class="toolbar hidden-print">
            <div class="text-end">
                ...
                @endif
                @if ($prInvoicePaid)
                    <a wire:click='convertProformInvoice()' class="btn btn-success px-5"
                        fdprocessedid="v2qwlg">Convert to Proforma
                    </a>
                @endif
        ...
        @endif
        @php
            $totalExpense = collect($estimate['expenses'])->sum('amount');
        @endphp
        @if ($totalExpense > 0)
        ...
        <div wire:loading.remove wire:target="updateEstimate" id="pdf" class="page card">
            <div class="card-body">
                ...
                <div class="footer-note">
                    Estimate was created digitally and is valid without signature.
                </div>
                    ...
                    <tbody>
                        @forelse($prInvoices as $prInvoice)
                            <tr>
                                ...
                                <td>
                                    <a
                                        href="{{ route($route . '.view-proformainvoice', $prInvoice?->proformaInvoice?->uuid) }}">
                                        {{ $prInvoice?->proformaInvoice?->proforma_invoice_no }}
                                    </a>
                                </td>
                            </tr>
                        @empty
