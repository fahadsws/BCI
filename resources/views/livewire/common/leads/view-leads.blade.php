...
<div class="card shadow-none border">
            ...
            @if ($leadData->stage_id == 1)
                @if (!$leadData->invoice)
                 <a href="{{ route($route.'.lead-edit', $leadId) }}" class="editbtn"><i class="fadeIn animated bx bx-edit"></i></a>
                @endif
            @endif
     @endcan</h5>
									...
									@endif
                                        ...
                                        @if ($leadData?->invoice?->invoice_no)
                                            <div class="d-flex align-items-center justify-content-between mb-2">
        										...
        										<p class="mb-0 text-dark fw-normal"> <a href="{{ route($route.'.view-invoice', $leadData?->invoice->invoice_id) }}" class="fw-500 text-primary">
