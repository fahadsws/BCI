        ...
        <nav class="navbar navbar-expand w-100">
            ...
            <div class="user-box dropdown ms-auto position-relative">
                ...
                <ul class="dropdown-menu dropdown-menu-end border shadow-sm py-2 mt-2 rounded-4">
                    <li>
                        <a href="{{ route('common.profile') }}" class="dropdown-item d-flex align-items-center px-3 py-2 darkgreytext">
                            <i class="bx bx-user me-2 fs-6 darkgreytext"></i>
                            <span>Profile</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('common.preferences') }}" class="dropdown-item d-flex align-items-center px-3 py-2 darkgreytext">
                            <i class="bx bx-cog me-2 fs-6 darkgreytext"></i>
                            <span>Settings</span>
                        </a>
                    </li>
                    <li>
